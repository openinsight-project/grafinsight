...
import { InlineFormLabel, LegacyForms, TableInputCSV, Icon } from '@grafinsight/ui';
const { Select } = LegacyForms;
import { DataFrame, toCSV, SelectableValue, MutableDataFrame, QueryEditorProps } from '@grafinsight/data';
