...
import { TableInputCSV } from '@grafinsight/ui';
import { DataSourcePluginOptionsEditorProps, DataFrame, MutableDataFrame } from '@grafinsight/data';
  ...
  render() {
    ...
    return (
      <div>
        ...
        <div className="grafinsight-info-box">
