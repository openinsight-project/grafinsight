...
import { Pagination, Tooltip, HorizontalGroup, stylesFactory, LinkButton, Input, Icon } from '@grafinsight/ui';
            ...
            <table className="filter-table form-inline filter-table--hover">
              <thead>
                <tr>
                  ...
                  <th>
                    Seen&nbsp;
                    <Tooltip placement="top" content="Time since user was seen using GrafInsight">
  ...
  return (
    <tr key={user.id}>
      ...
      <td className="link-td">
        {user.isAdmin && (
          <a href={editUrl}>
            <Tooltip placement="top" content="GrafInsight Admin">
              <Icon name="shield" />
            </Tooltip>
          </a>
        )}
