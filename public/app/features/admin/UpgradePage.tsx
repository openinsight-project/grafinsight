...
export const UpgradePage: React.FC<Props> = ({ navModel }) => {
  return (
    <Page navModel={navModel}>
      <Page.Contents>
        <UpgradeInfo
          editionNotice="You are running the open-source version of GrafInsight.
...
export const UpgradeInfo: React.FC<UpgradeInfoProps> = ({ editionNotice }) => {
  ...
  return (
    <LicenseChrome header="GrafInsight Enterprise" subheader="Get your free trial" editionNotice={editionNotice}>
...
const GetEnterprise: React.FC = () => {
  return (
    <div style={{ marginTop: '40px', marginBottom: '30px' }}>
      <h2 style={titleStyles}>Get GrafInsight Enterprise</h2>
      <CallToAction />
...
const CallToAction: React.FC = () => {
  return (
    <LinkButton
      variant="primary"
      size="lg"
      href="https://grafinsight.com/contact?about=grafinsight-enterprise&utm_source=grafinsight-upgrade-page"
    >
  ...
  return (
    <div>
      ...
      <div style={{ marginTop: '20px' }}>
        ...
        <br />
        Indemnification, working with GrafInsight Labs on future prioritization, and training from the core GrafInsight team.
      </div>
...
const FeatureListing: React.FC = () => {
  return (
    <List>
      ...
      <Item title="Auditing" />
      <Item title="GrafInsight usage insights">
        <List nested={true}>
