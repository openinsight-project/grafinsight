...
import { DataSourceApi, FieldType, getFieldDisplayName, isDataFrame, MetricFindValue, PanelData } from '@grafinsight/data';
  ...
  return (source) =>
    source.pipe(
      mergeMap(() => {
        ...
        // The if statement below fixes https://github.com/grafinsight/grafinsight/issues/25671
        if (!searchFilter) {
