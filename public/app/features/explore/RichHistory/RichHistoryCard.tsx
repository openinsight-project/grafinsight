...
import { stylesFactory, useTheme, TextArea, Button, IconButton } from '@grafinsight/ui';
import { getDataSourceSrv } from '@grafinsight/runtime/src';
import { GrafInsightTheme, AppEvents, DataSourceApi } from '@grafinsight/data';
...
const getStyles = stylesFactory((theme: GrafInsightTheme, isRemoved: boolean) => {
