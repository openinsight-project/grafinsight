...
import { Button, Icon, Input, Pagination, stylesFactory, useStyles } from '@grafinsight/ui';
import { DateTimeInput, GrafInsightTheme, LoadingState } from '@grafinsight/data';
...
const getPanelViewStyles = stylesFactory((theme: GrafInsightTheme) => {
  return {
    container: css`
      display: flex;
