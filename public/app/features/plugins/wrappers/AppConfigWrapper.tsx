...
import { Button } from '@grafinsight/ui';
import { PluginMeta, AppPlugin, deprecationWarning } from '@grafinsight/data';
import { AngularComponent, getAngularLoader, getBackendSrv } from '@grafinsight/runtime/src';
