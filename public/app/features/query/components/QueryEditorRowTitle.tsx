...
import { DataQuery, GrafInsightTheme } from '@grafinsight/data';
import { FieldValidationMessage, Icon, Input, stylesFactory, useTheme } from '@grafinsight/ui';
...
const getQueryEditorRowTitleStyles = stylesFactory((theme: GrafInsightTheme) => {
  return {
    wrapper: css`
      display: flex;
      align-items: center;
