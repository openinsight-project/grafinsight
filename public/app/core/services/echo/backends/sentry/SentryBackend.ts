import { EchoBackend, EchoEventType } from '@grafinsight/runtime/src';
import { SentryConfig } from '@grafinsight/data/src/types/config';
...
import { BuildInfo } from '@grafinsight/data';
