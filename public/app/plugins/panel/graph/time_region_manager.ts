...
import { getColorForTheme, dateTime, DateTime, AbsoluteTimeRange, GrafInsightTheme } from '@grafinsight/data';
...
function getColor(timeRegion: any, theme: GrafInsightTheme): TimeRegionColorDefinition {
