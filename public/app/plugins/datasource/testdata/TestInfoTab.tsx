...
// Types
import { PluginConfigPageProps, DataSourcePluginMeta, DataSourceJsonData } from '@grafinsight/data';
    ...
    return (
      <div>
        ...
        <a
          ...
          href="https://github.com/grafinsight/grafinsight/tree/master/devenv"
          target="_blank"
