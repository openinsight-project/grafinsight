import { DataSourceInstanceSettings, FieldType, MutableDataFrame, PluginType } from '@grafinsight/data';
import { backendSrv } from 'app/core/services/backend_srv';
import { of } from 'rxjs';
import { createFetchResponse } from 'test/helpers/createFetchResponse';
import { TempoDatasource } from './datasource';

jest.mock('../../../../../packages/grafinsight-runtime/src/services/backendSrv.ts', () => ({
  getBackendSrv: () => backendSrv,
}));

jest.mock('../../../../../packages/grafinsight-runtime/src/utils/queryResponse.ts', () => ({
