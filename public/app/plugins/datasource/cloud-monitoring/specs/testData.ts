export const metricDescriptors = [
  {
    name: 'projects/grafinsight-prod/metricDescriptors/agent.googleapis.com/agent/api_request_count',
    labels: [
      {
        key: 'state',
  ...
  {
    name: 'projects/grafinsight-prod/metricDescriptors/agent.googleapis.com/agent/log_entry_count',
    labels: [
      {
        key: 'response_code',
