...
import { DataSourceHttpSettings, InlineFormLabel, LegacyForms } from '@grafinsight/ui';
  ...
  renderTypeHelp = () => {
    return (
      <p>
        ...
        are using{' '}
        <a href="https://github.com/grafinsight/metrictank" className="pointer" target="_blank" rel="noreferrer">
          Metrictank
        </a>{' '}
