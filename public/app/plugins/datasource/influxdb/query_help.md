...
#### Group by time
- Group by time is important, otherwise the query could return many thousands of datapoints that will slow down GrafInsight
...
[GrafInsight's InfluxDB Documentation](http://docs.grafinsight.org/features/datasources/influxdb)
