import { BusEventBase, BusEventWithPayload, eventFactory, GrafInsightTheme, TimeRange } from '@grafinsight/data';
...
export class ThemeChangedEvent extends BusEventWithPayload<GrafInsightTheme> {
