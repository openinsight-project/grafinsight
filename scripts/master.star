...
def master_pipelines(edition):
    ...
    if edition != 'enterprise':
        ...
        pipelines.append(notify_pipeline(
            name='notify-master', slack_channel='grafinsight-ci-notifications', trigger=trigger,
        ...
        pipelines.append(notify_pipeline(
            name='notify-master-downstream', slack_channel='grafinsight-enterprise-ci-notifications', trigger=trigger,
