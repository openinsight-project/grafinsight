...
func main() {
	...
	flag.StringVar(&whatsNewURL, "wn", "", "What's new url (ex: --wn https://github.com/openinsight-project/grafinsight)")
	flag.StringVar(&releaseNotesURL, "rn", "", "Grafana version (ex: --rn https://github.com/openinsight-project/grafinsight)")
	...
	if len(os.Args) == 1 {
		...
		fmt.Println("example: go run publisher.go main.go --version v5.2.0-beta2 --wn https://github.com/openinsight-project/grafinsight --rn https://github.com/openinsight-project/grafinsight --apikey ASDF123 --dry-run --enterprise")
		os.Exit(1)
	}
