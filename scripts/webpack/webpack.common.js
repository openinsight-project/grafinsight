...
module.exports = {
  ...
  output: {
    ...
    // Keep publicPath relative for host.com/grafinsight/ deployments
  ...
  resolve: {
    ...
    alias: {
      ...
      // we want to have same Prism object in core and in grafinsight/ui
      prismjs: path.resolve(__dirname, '../../node_modules/prismjs'),
    },
    modules: [
      'node_modules',
      path.resolve('public'),
      // we need full path to root node_modules for grafinsight-enterprise symlink to work
