...
COPY --from=go-builder /go/src/github.com/grafinsight/grafinsight/bin/linux-amd64/grafinsight-server /go/src/github.com/grafinsight/grafinsight/bin/linux-amd64/grafinsight-cli ./bin/
