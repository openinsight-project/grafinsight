...
curl -fL -o /usr/local/bin/grabpl "https://grafinsight-downloads.storage.googleapis.com/grafinsight-build-pipeline/v0.5.38/grabpl"
...
# Install grafinsight-toolkit deps
current_dir=$PWD
cd /usr/local/grafinsight-toolkit && yarn install && cd $current_dir
ln -s /usr/local/grafinsight-toolkit/bin/grafinsight-toolkit.js /usr/local/bin/grafinsight-toolkit
