...
const PluginNames: Record<PluginType, string> = {
  'panel-plugin': 'GrafInsight Panel Plugin',
  'datasource-plugin': 'GrafInsight Data Source Plugin',
  'backend-datasource-plugin': 'GrafInsight Backend Datasource Plugin',
};
const RepositoriesPaths: Record<PluginType, string> = {
  'panel-plugin': 'https://github.com/grafinsight/simple-react-panel.git',
  'datasource-plugin': 'https://github.com/grafinsight/simple-datasource.git',
  'backend-datasource-plugin': 'https://github.com/grafinsight/simple-datasource-backend.git',
};
const TutorialPaths: Record<PluginType, string> = {
  'panel-plugin': 'https://grafinsight.com/tutorials/build-a-panel-plugin',
  'datasource-plugin': 'https://grafinsight.com/tutorials/build-a-data-source-plugin',
...
export const printGrafInsightTutorialsDetails = (type: PluginType) => {
  console.group();
  console.log();
  ...
  console.log(
    'Learn more about GrafInsight Plugins at https://grafinsight.com/docs/grafinsight/latest/plugins/developing/development/'
  );
  console.log();
  console.groupEnd();
};
