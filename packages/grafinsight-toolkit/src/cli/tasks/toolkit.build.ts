...
const preparePackage = async (pkg: any) => {
  pkg.bin = {
    'grafinsight-toolkit': './bin/grafinsight-toolkit.js',
  };
...
export const toolkitBuildTask = new Task<ToolkitBuildOptions>('@grafinsight/toolkit build', toolkitBuildTaskRunner);
