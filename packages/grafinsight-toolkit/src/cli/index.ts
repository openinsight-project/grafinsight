...
export const run = (includeInternalScripts = false) => {
  if (includeInternalScripts) {
    ...
    program
      ...
      .description('Starts GrafInsight front-end in development mode with watch enabled')
      .action(async (cmd) => {
    ...
    program
      ...
      .description('Builds @grafinsight/* package to packages/grafinsight-*/dist')
      .action(async (cmd) => {
    ...
    program
      .command('cherrypick')
      .option('-e, --enterprise', 'Run task for grafinsight-enterprise')
    ...
    program
      ...
      .description('Prepares grafinsight/toolkit dist package')
      .action(async (cmd) => {
  ...
  program
    ...
    .option('--yarnlink', 'symlink this project to the local grafinsight/toolkit')
