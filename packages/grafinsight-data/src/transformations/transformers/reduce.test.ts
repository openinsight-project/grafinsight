...
describe('Reducer Transformer', () => {
  ...
  it('reduces multiple data frames with decimal display name (https://github.com/grafinsight/grafinsight/issues/31580)', async () => {
    const cfg = {
      id: DataTransformerID.reduce,
      options: {
  ...
  it('reduces multiple data frames with decimal fields name (https://github.com/grafinsight/grafinsight/issues/31580)', async () => {
    const cfg = {
      id: DataTransformerID.reduce,
      options: {
        reducers: [ReducerID.max],
