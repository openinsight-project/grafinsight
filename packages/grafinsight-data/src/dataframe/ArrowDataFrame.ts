 ...
 * display within grafinsight.  This typically includes any labels defined in the metadata.
 *
 * When using this function to round-trip data, be sure to set `keepOriginalNames=true`
 */
export function grafinsightDataFrameToArrowTable(data: DataFrame, keepOriginalNames?: boolean): Table {
