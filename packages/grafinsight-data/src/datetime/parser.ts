...
export interface DateTimeOptionsWhenParsing extends DateTimeOptions {
  /**
   * If the input is a GrafInsight quick date, e.g. now-6h, then you can specify this to control
 ...
 *
 * It can also parse the GrafInsight quick date and time format, e.g. now-6h will be parsed as Date.now() - 6 hours and
