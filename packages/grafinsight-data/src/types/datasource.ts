...
import { GrafInsightPlugin, PluginMeta } from './plugin';
...
export class DataSourcePlugin<
  ...
  TSecureOptions = {}
> extends GrafInsightPlugin<DataSourcePluginMeta<TOptions>> {
...
export interface DataQueryResponse {
   ...
   * Use this key to inform GrafInsight how to combine the partial responses
