export enum GrafInsightThemeType {
  Light = 'light',
  Dark = 'dark',
}

export interface GrafInsightThemeCommons {
  name: string;
...
export interface GrafInsightTheme extends GrafInsightThemeCommons {
  type: GrafInsightThemeType;
  isDark: boolean;
  isLight: boolean;
  palette: {
    black: string;
