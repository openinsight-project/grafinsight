...
/** Describes {@link https://grafinsight.com/docs/grafinsight/latest/plugins | type of plugin} */
...
/** Describes status of {@link https://grafinsight.com/docs/grafinsight/latest/plugins/plugin-signatures/ | plugin signature} */
...
/** Describes error code returned from GrafInsight plugins API call */
...
/** Describes error returned from GrafInsight plugins API call */
...
export class GrafInsightPlugin<T extends PluginMeta = PluginMeta> {
