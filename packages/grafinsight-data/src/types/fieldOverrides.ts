...
import { MatcherConfig, FieldConfig, Field, DataFrame, GrafInsightTheme, TimeZone } from '.';
...
/**
 * Describes config override rules created when interacting with GrafInsight.
 *
 * @internal
 */
