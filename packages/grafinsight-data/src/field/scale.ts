...
import { Field, FieldConfig, FieldType, GrafInsightTheme, NumericRange, Threshold } from '../types';
...
export function getScaleCalculator(field: Field, theme: GrafInsightTheme): ScaleCalculator {
