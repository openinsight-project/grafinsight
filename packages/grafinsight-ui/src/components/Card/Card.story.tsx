...
const logo = 'https://grafinsight.com/static/assets/img/apple-touch-icon.png';
...
export const WithMedia: Story<Props> = ({ disabled }) => {
  return (
    <Card href="https://ops-us-east4.grafinsight.net/api/prom" heading="1-ops-tools1-fallback" disabled={disabled}>
      <Card.Meta>
        Prometheus
        <a key="link2" href="https://ops-us-east4.grafinsight.net/api/prom">
          https://ops-us-east4.grafinsight.net/api/prom
        </a>
      </Card.Meta>
      <Card.Figure>
  ...
  return (
    ...
    >
      <Card.Meta>
        ...
        <a key="link" href="https://ops-us-east4.grafinsight.net/api/prom">
          https://ops-us-east4.grafinsight.net/api/prom
        </a>
      </Card.Meta>
      <Card.Figure>
