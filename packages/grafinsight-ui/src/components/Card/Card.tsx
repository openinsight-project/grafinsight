 ...
 * @public
 */
export const getContainerStyles = stylesFactory((theme: GrafInsightTheme, disabled = false, disableHover = false) => {
  return css`
    display: flex;
    width: 100%;
 ...
 * @public
 */
export const getCardStyles = stylesFactory((theme: GrafInsightTheme) => {
  return {
    inner: css`
      display: flex;
