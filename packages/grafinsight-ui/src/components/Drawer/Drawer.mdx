...
One example of the Drawer in use is in GrafInsight's [panel inspector](https://grafinsight.com/docs/grafinsight/latest/panels/inspect-panel/).

### Usage
```tsx
import { Drawer } from '@grafinsight/ui';
