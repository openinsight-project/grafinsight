...
This label component is used in full-page forms in GrafInsight, for example in the datasource settings. In some parts of GrafInsight, there are inline forms which do not use this type of label.
