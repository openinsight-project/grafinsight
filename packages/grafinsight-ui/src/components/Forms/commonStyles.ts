...
export const getFocusStyle = (theme: GrafInsightTheme) => css`
  &:focus {
    ${focusCss(theme)}
  }
`;

export const sharedInputStyle = (theme: GrafInsightTheme, invalid = false) => {
...
export function getPropertiesForButtonSize(size: ComponentSize, theme: GrafInsightTheme) {
