...
# BigValue
Component for showing a value based on a [DisplayValue](https://grafinsight.com/docs/grafinsight/latest/packages_api/data/displayvalue/#displayvalue-interface).
...
### Example usage
An example usage is in the [Stat panel](https://grafinsight.com/docs/grafinsight/latest/panels/visualizations/stat-panel/).

```tsx
import { DisplayValue } from '@grafinsight/data';
import {
  BigValue,
  BigValueColorMode,
  BigValueGraphMode,
