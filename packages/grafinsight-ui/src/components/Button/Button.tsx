...
function getButtonVariantStyles(from: string, to: string, textColor: string, theme: GrafInsightTheme) {
  return css`
...
export function getPropertiesForVariant(theme: GrafInsightTheme, variant: ButtonVariant) {
  switch (variant) {
    case 'secondary':
