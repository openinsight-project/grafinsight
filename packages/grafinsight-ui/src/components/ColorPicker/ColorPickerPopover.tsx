...
import { GrafInsightTheme, GrafInsightThemeType, getColorForTheme } from '@grafinsight/data';
    ...
    return (
      <div
        className={cx(
          ...
          theme.type === GrafInsightThemeType.Light ? styles.colorPickerPopoverLight : styles.colorPickerPopoverDark
        )}
      >
