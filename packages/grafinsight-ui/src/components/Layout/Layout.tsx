...
const getStyles = stylesFactory(
  (theme: GrafInsightTheme, orientation: Orientation, spacing: Spacing, justify: Justify, align, wrap) => {
...
const getContainerStyles = stylesFactory((theme: GrafInsightTheme, padding?: Spacing, margin?: Spacing) => {
