import { DataFrame, DataLink, GrafInsightTheme, VariableSuggestion } from '@grafinsight/data';
...
const getDataLinksInlineEditorStyles = stylesFactory((theme: GrafInsightTheme) => {
  return {
    wrapper: css`
