...
import { DataLinkBuiltInVars, GrafInsightTheme, VariableOrigin, VariableSuggestion } from '@grafinsight/data';
...
export const DataLinkInput: React.FC<DataLinkInputProps> = memo(
  ({ value, onChange, suggestions, placeholder = 'http://your-grafinsight.com/d/000000010/annotations' }) => {
