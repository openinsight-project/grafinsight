...
import { Dimensions2D, GrafInsightTheme } from '@grafinsight/data';
...
const getTooltipContainerStyles = stylesFactory((theme: GrafInsightTheme) => {
  return {
    wrapper: css`
      overflow: hidden;
      background: ${theme.colors.bg2};
      /* max-width is set up based on .grafinsight-tooltip class that's used in dashboard */
      max-width: 800px;
