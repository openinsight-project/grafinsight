...
export interface InfoBoxProps extends Omit<React.HTMLAttributes<HTMLDivElement>, 'title'> {
  ...
  urlTitle?: string;
  /** Indicates whether or not box should be rendered with GrafInsight branding background */
  branded?: boolean;
...
const getInfoBoxStyles = stylesFactory((theme: GrafInsightTheme, severity: AlertVariant) => ({
  wrapper: css`
    position: relative;
