...
function getHoverColor(theme: GrafInsightTheme, surface: SurfaceType): string {
  switch (surface) {
    case 'dashboard':
...
const getStyles = stylesFactory((theme: GrafInsightTheme, surface: SurfaceType, size: IconSize) => {
