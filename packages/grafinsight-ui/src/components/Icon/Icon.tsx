...
import { GrafInsightTheme, toPascalCase } from '@grafinsight/data';
...
const alwaysMonoIcons: IconName[] = ['grafinsight', 'favorite', 'heart-break', 'heart', 'panel-add', 'reusable-panel'];
...
const getIconStyles = stylesFactory((theme: GrafInsightTheme) => {
  return {
    container: css`
      label: Icon;
