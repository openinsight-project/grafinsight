...
import { dateTime, DateTime, dateTimeParse, GrafInsightTheme, TimeZone } from '@grafinsight/data';
...
const getStyles = stylesFactory((theme: GrafInsightTheme, isReversed = false) => {
...
const getFooterStyles = stylesFactory((theme: GrafInsightTheme) => {
  return {
    container: css`
      background-color: ${theme.colors.bodyBg};
      display: flex;
...
const getBodyStyles = stylesFactory((theme: GrafInsightTheme) => {
  return {
    title: css`
...
const getHeaderStyles = stylesFactory((theme: GrafInsightTheme) => {
  return {
    container: css`
      background-color: ${theme.colors.bodyBg};
      display: flex;
