import { GrafInsightTheme, isDateTime, TimeOption, TimeRange, TimeZone } from '@grafinsight/data';
...
const getStyles = stylesFactory((theme: GrafInsightTheme, isReversed, hideQuickRanges, isContainerTall) => {
...
const getNarrowScreenStyles = stylesFactory((theme: GrafInsightTheme) => {
  return {
    header: css`
      display: flex;
      flex-direction: row;
...
const getFullScreenStyles = stylesFactory((theme: GrafInsightTheme, hideQuickRanges?: boolean) => {
  return {
    container: css`
      padding-top: 9px;
      padding-left: 11px;
...
const getEmptyListStyles = stylesFactory((theme: GrafInsightTheme) => {
    ...
    <div className={styles.container}>
      ...
      <div>
        <a
          ...
          href="https://grafinsight.com/docs/grafinsight/latest/dashboards/time-range-controls"
          target="_new"
        >
