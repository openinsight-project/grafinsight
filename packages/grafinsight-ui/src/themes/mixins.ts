...
export function cardChrome(theme: GrafInsightTheme): string {
  return `
...
export function hoverColor(color: string, theme: GrafInsightTheme): string {
  return theme.isDark ? tinycolor(color).brighten(2).toString() : tinycolor(color).darken(2).toString();
}

export function listItem(theme: GrafInsightTheme): string {
  return `
  background: ${theme.colors.bg2};
  &:hover {
    background: ${hoverColor(theme.colors.bg2, theme)};
...
export function listItemSelected(theme: GrafInsightTheme): string {
  return `
       background: ${hoverColor(theme.colors.bg2, theme)};
...
export const focusCss = (theme: GrafInsightTheme) => `
