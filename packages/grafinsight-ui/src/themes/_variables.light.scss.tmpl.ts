...
export const lightThemeVarsTemplate = (theme: GrafInsightTheme) =>
  `${renderGeneratedFileBanner('grafinsight-ui/src/themes/light.ts', 'grafinsight-ui/src/themes/_variable.light.scss.tmpl.ts')}
// Global values
// --------------------------------------------------
