...
import { GrafInsightThemeType, GrafInsightTheme } from '@grafinsight/data';
...
const lightTheme: GrafInsightTheme = {
  ...defaultTheme,
  type: GrafInsightThemeType.Light,
  isDark: false,
  isLight: true,
  name: 'GrafInsight Light',
  palette: {
    ...basicColors,
