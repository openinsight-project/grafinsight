...
export const darkThemeVarsTemplate = (theme: GrafInsightTheme) =>
  `${renderGeneratedFileBanner('grafinsight-ui/src/themes/dark.ts', 'grafinsight-ui/src/themes/_variables.dark.scss.tmpl.ts')}
// Global values
// --------------------------------------------------
