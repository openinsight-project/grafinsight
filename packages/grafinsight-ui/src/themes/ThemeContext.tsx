import { GrafInsightTheme, GrafInsightThemeType } from '@grafinsight/data';
 ...
 * Mock used in tests
 */
let ThemeContextMock: React.Context<GrafInsightTheme> | null = null;

// Used by useStyles()
export const memoizedStyleCreators = new WeakMap();

// Use GrafInsight Dark theme by default
export const ThemeContext = React.createContext(getTheme(GrafInsightThemeType.Dark));
...
export function useTheme(): GrafInsightTheme {
 ...
 * */
export function useStyles<T>(getStyles: (theme: GrafInsightTheme) => T) {
 ...
 */
export const mockThemeContext = (theme: Partial<GrafInsightTheme>) => {
  ThemeContextMock = React.createContext(theme as GrafInsightTheme);
  return () => {
