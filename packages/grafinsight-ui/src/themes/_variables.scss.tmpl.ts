...
import { GrafInsightThemeCommons } from '@grafinsight/data';
import { renderGeneratedFileBanner } from '../utils/generatedFileBanner';

export const commonThemeVarsTemplate = (theme: GrafInsightThemeCommons) =>
  `${renderGeneratedFileBanner('grafinsight-ui/src/themes/default.ts', 'grafinsight-ui/src/themes/_variables.scss.tmpl.ts')}
// Options
//
