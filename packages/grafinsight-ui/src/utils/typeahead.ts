...
export const calculateListSizes = (theme: GrafInsightTheme, allItems: CompletionItem[], longestLabel: string) => {
...
export const calculateItemHeight = (longestLabelHeight: number, theme: GrafInsightTheme) => {
...
export const calculateListWidth = (longestLabelWidth: number, theme: GrafInsightTheme) => {
