...
const createTheme = (theme: GrafInsightTheme) => {
  return create({
    ...
    brandTitle: 'GrafInsight UI',
    brandUrl: './',
    brandImage: './grafinsight_icon.svg',
  });
};

const GrafInsightLight = createTheme(lightTheme);
const GrafInsightDark = createTheme(darkTheme);

export { GrafInsightLight, GrafInsightDark };
