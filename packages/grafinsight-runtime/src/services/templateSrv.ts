import { VariableModel, ScopedVars } from '@grafinsight/data';
 ...
 *
 * For a more in-depth description visit: https://grafinsight.com/docs/grafinsight/latest/reference/templating
 * @public
 */
...
/**
 * Used during startup by GrafInsight to set the TemplateSrv so it is available
