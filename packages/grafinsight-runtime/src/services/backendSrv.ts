...
/**
 * Used to communicate via http(s) to a remote backend such as the GrafInsight backend,
 ...
 *
 * @remarks
 * By default, GrafInsight displays an error message alert if the remote call fails. To prevent this from
...
export interface BackendSrv {
   ...
   * events that the GrafInsight QueryInspector and QueryEditor is listening for to be able
...
/**
 * Used during startup by GrafInsight to set the BackendSrv so it is available
 ...
 * via http(s) to a remote backend such as the GrafInsight backend, a datasource etc.
 *
 * @public
 */
