import { ScopedVars, DataSourceApi, DataSourceInstanceSettings } from '@grafinsight/data';
 ...
 * to the {@link @grafinsight/data#DataSourceApi | DataSourceApi} that have a rich API for
...
/**
 * Used during startup by GrafInsight to set the DataSourceSrv so it is available
