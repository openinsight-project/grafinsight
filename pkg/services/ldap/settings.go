...
type GroupToOrgRole struct {
	...
	IsGrafinsightAdmin *bool `toml:"grafinsight_admin"`
...
func readConfig(configFile string) (*Config, error) {
	...
	// nolint:gosec
	// We can ignore the gosec G304 warning on this one because `filename` comes from grafinsight configuration file
