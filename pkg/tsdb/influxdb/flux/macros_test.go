...
func TestInterpolate(t *testing.T) {
	...
	options := queryOptions{
		Organization:  "grafinsight1",
		Bucket:        "grafinsight2",
		DefaultBucket: "grafinsight3",
	}
	...
	tests := []struct {
	...
	}{
		{
			...
			after:  `1970-01-01T00:00:00Z, 1970-01-01T00:00:00Z, "grafinsight2", "grafinsight3", "grafinsight1", 1s, a91{}.bucket`,
		},
	}
