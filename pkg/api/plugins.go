...
func (hs *HTTPServer) GetPluginList(c *models.ReqContext) response.Response {
	...
	for _, pluginDef := range plugins.Plugins {
		...
		listItem := dtos.PluginListItem{
			...
			Info:          &pluginDef.Info,
			LatestVersion: pluginDef.GrafinsightNetVersion,
			HasUpdate:     pluginDef.GrafinsightNetHasUpdate,
...
func GetPluginSettingByID(c *models.ReqContext) response.Response {
	...
	dto := &dtos.PluginSetting{
		...
		LatestVersion: def.GrafinsightNetVersion,
		HasUpdate:     def.GrafinsightNetHasUpdate,
		State:         def.State,
