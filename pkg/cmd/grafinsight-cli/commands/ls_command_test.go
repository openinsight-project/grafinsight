...
func TestMissingPath(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			cliContext:  map[string]string{"pluginsDir": "/var/lib/grafinsight/plugins/notadir.txt"},
...
func TestValidateLsCommand_override(t *testing.T) {
	...
	t.Run("override validateLsCommand", func(t *testing.T) {
		...
		c, err := commandstest.NewCliContext(map[string]string{"path": "/var/lib/grafinsight/plugins"})
		require.NoError(t, err)
