...
// ParseInterval parses an interval with support for all units that Grafinsight uses.
...
// ParseDuration parses a duration with support for all units that Grafinsight uses.
